...
/**
  @file main_cons.c
  @brief Performs the consumer in the producer/consumer problem synchronized with only semaphores in the case that the shared resource is an integer variable in a shared memory
  */
